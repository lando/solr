---
title: Development
description: Learn how to develop and contribute to the Lando Solr service
---
...
This plugin contains various working and tested Lando apps in the [examples](https://github.com/lando/solr/tree/main/examples) folder. You should use these or create new ones to help with plugin development.
